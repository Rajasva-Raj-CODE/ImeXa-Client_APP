        ...
        <div className="mb-12">
          ...
          {showSubtitle1 && (
            <div className="animate-fade-in-blur stagger-animation stagger-2">
              <p className="text-lg md:text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed glass-card">
                At ImeXa, we've built an advanced virtual training platform designed to
                upgrade how companies train their teams. Using the power of VR, AR,
                and AI-based analytics, ImeXa takes learning beyond the classroom.
              </p>
            </div>
          )}
        </div>
          ...
          <div className="mb-12">
            <h2 className="text-3xl md:text-5xl font-bold mb-6 transform hover:scale-105 transition-all duration-300 text-glow">
              <span className="bg-gradient-to-r from-accent via-primary to-secondary bg-clip-text text-transparent">
                {typewriterText2}
                {!showSubtitle2 && (
                  <span className="animate-blink border-r-2 border-accent"></span>
                )}
              </span>
            </h2>
            ...
            {showSubtitle2 && (
              <div className="animate-bounce-in stagger-animation stagger-3">
                <p className="text-lg md:text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed mb-8 glass-card">
                  ImeXa lets you train smarter and faster with interactive, real-life
                  simulations. You can track employee progress in real time, scale
                  training across teams easily, and keep people engaged with hands-on
                  learning. Whether it's healthcare, manufacturing, or safety
                  training, ImeXa makes training more effective, data-driven, and
                  future-ready.
                </p>
              </div>
            )}
